...
void WriteLocalData(const std::string&& filename,
...
void DumpFluidData(chrono::ChSystemParallelDVI* system, std::string filename, bool binary = true) {
...
void DumpAllObjectsWithGeometryPovray(ChSystem* mSys, std::string filename, bool binary = false) {
    CSVGen csv_output;
